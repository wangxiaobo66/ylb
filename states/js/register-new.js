var userName=false,passwordName=false,passwordAgainName=false,corporationName=false,nameName=false,areaCodeName=false,telName=false,emailName=false,phoneName=false,codeName=false,areaName=false;
$(function(){
    ...
    $('.area').on('click','span',function(){
        ...
        areaNum = $(this).attr('name');
    })
    //选择地区
    $('.btn-register').on('click',function(){
        console.log(userName,passwordName,passwordAgainName,corporationName,nameName,emailName,phoneName,codeName);
        if (userName==true&&passwordName==true&&passwordAgainName==true&&corporationName==true&&nameName==true&&emailName==true&&phoneName==true&&codeName==true&&areaName==true) {
            $.get("/mobile.Member/regist?loginid="+$('.user').val()+"&password="+$('.password').val()+"&pwd="+$('.passwordAgain').val()+"&company="+encodeURIComponent($('.corporation').val())+"&contact="+encodeURIComponent($('.name').val())+"&&mphone="+$('.phone').val()+"&email="+$('.email').val()+"&msession="+msession+"&areaid="+areaNum,function(data){
